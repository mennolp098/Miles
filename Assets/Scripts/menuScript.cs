...
public class menuScript : MonoBehaviour {
	...
	void OnGUI()
    {
        ...
        {
            if (GUI.Button(new Rect(_middelPoint.x - (_buttonSize.x * 4.2f), _middelPoint.y, _buttonSize.x *2, _buttonSize.y *2), "Play"))
            {
                _menus[1].SetActive(false);
                _menus[2].SetActive(true);
            }
            if (GUI.Button(new Rect(_middelPoint.x - (_buttonSize.x * 4.2f), _middelPoint.y + (_buttonSize.y * 2), _buttonSize.x * 2, _buttonSize.y), "help"))
            {
                _menus[1].SetActive(false);
                _menus[3].SetActive(true);
            }
            if (GUI.Button(new Rect(_middelPoint.x - (_buttonSize.x * 4.2f), _middelPoint.y + (_buttonSize.y * 3), _buttonSize.x * 1.3f, _buttonSize.y), "cedits"))
            {
                _menus[1].SetActive(false);
        ...
        {
            if (GUI.Button(new Rect(_middelPoint.x - (_buttonSize.x * 4.2f), _middelPoint.y + (_buttonSize.y * 2.7f), _buttonSize.x * 1.3f, _buttonSize.y *1.2f), "cedits"))
            {
            ...
            {
                if (GUI.Button(new Rect(_middelPoint.x + (_buttonSize.x * 3), _middelPoint.y + (_buttonSize.y * 2.7f), _buttonSize.x * 1.3f, _buttonSize.y * 1.2f), "cedits"))
                {
